...
#include <unordered_set>
#include <vector>
// __int64/__uint64/CRITICAL_SECTION/etc are MSVC builtins/Win32 types that
// don't exist under GCC - LinuxTypes.h/LinuxStubs.h (from Minecraft.World's
// Phase 2 port) are the same shim Minecraft.World/stdafx.h uses, needed here
// before extraX64.h (included below) can compile.
#include "../Minecraft.World/LinuxExtras/LinuxTypes.h"
#include "../Minecraft.World/LinuxExtras/LinuxStubs.h"
// Same two-phase-lookup issue Minecraft.World/stdafx.h already hit in
// Phase 2: MSVC's <tchar.h>/<windows.h> pull these in transitively, GCC
// needs them explicit and visible before any template bodies that use them.
#include <cstring>
#include <climits>
#include <cfloat>
#include <functional>
#include <math.h>
// DirectXMath (Windows-only) equivalent for Camera.cpp's non-console matrix
// math - see that header's comment for scope. Brought in unqualified here,
// same effect as _WINDOWS64's `using namespace DirectX;` below.
#include "Linux/LinuxExtras/LinuxDirectXMathShim.h"
#else
#define AUTO_VAR(_var, _val) auto _var = _val
#include <unordered_map>
#include <unordered_set>
...
#elif defined _LINUX64
	// MinecraftTelemetry/strings/DynamicConfigurations/SentientTelemetryCommon/
