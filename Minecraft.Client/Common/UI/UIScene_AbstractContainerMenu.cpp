...
void UIScene_AbstractContainerMenu::PlatformInitialize(int iPad, int startIndex)
{
	...
	//Y coordinate of the touch point (0 to 941: DUALSHOCK4 wireless controllers and the CUH-ZCT1J/CAP-ZCT1J/CAP-ZCT1U controllers for the PlayStation4 development tool,    
	//0 to 753: JDX-1000x series controllers for the PlayStation4 development tool,)     
