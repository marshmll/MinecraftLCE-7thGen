...
// 	};
	...
	// unconditionally on every platform, but this header started as a copy
	// of Windows64's 4J_Storage.h, which (like PS3/Xbox 360's) is missing
	// them; only Orbis/Durango's copies declare them. Added here matching
	// those signatures rather than editing the shared Windows64 header.
